...
let { data } = await axios.get('https://loli-api.glitch.me/api/v1/twintails');
 var callback = () => api.sendMessage({body:`Bắt vài bé loli về nuôi nào :))`,attachment: fs.createReadStream(__dirname + '/cache/101.jpg')}, event.threadID, () => fs.unlinkSync(__dirname + '/cache/101.jpg'));	
